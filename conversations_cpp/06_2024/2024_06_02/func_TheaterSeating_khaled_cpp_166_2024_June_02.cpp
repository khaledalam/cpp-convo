/***
 ...
 khaled_cpp_166_2024_June_02: 0dba7fad-412b-4dc0-b8ab-48c1ade2320d


func_TheaterSeating_khaled_cpp_166_2024_June_02


Write me a C++ function called TheaterSeating that takes two inputs of type int called rows and people.
...
Please don't forget to validate the inputs.
...
std::vector<std::pair<int, int>> TheaterSeating(int rows, int people) {
    if (rows <= 0) {
...
int main() {
    // TEST
    assert((TheaterSeating(5, 5) == std::vector<std::pair<int, int>>{{1, 5}, {2, 5}, {3, 5}, {4, 5}, {5, 5}}));
    // TEST_END

    // TEST
    assert((TheaterSeating(4, 2) == std::vector<std::pair<int, int>>{{1, 5}, {2, 5}}));
    // TEST_END

    // TEST
    assert((TheaterSeating(1, 2) == std::vector<std::pair<int, int>>{{1, 5}, {1, 8}}));
    // TEST_END
